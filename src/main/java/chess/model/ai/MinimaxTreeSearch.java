...
public class MinimaxTreeSearch {
    ...
    public Move runAndGetBestMove() {
        ...
        Move selectedMove = bestNodes.isEmpty() ? null
                : bestNodes.get((int) (Math.random() * bestNodes.size())).getMoveFromParent();
        if (selectedMove != null) {
            // logger.log(" → Movimiento mejor evaluado: " + selectedMove + " (score: " +
            // best + ")");
        }
