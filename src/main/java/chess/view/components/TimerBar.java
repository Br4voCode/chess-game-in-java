...
public class TimerBar extends VBox {
    ...
    private void initializeUI() {
        this.setStyle(
                "-fx-padding: 8; -fx-background-color: transparent; -fx-background-radius: 10; -fx-border-radius: 10;");
    ...
    public void updateTimerDisplay() {
        if (gameClock != null) {
            ...
            if (timeRemaining <= 0) {
                timerLabel.setStyle(
                        "-fx-font-size: 20px; -fx-font-weight: bold; -fx-text-fill: #bbbbbb; -fx-font-family: 'Courier New';");
            } else {
                timerLabel.setStyle(
                        "-fx-font-size: 20px; -fx-font-weight: bold; -fx-text-fill: white; -fx-font-family: 'Courier New';");
            }
            ...
            if (isActive && gameClock.isRunning() && !gameClock.isPaused()) {
                this.setStyle(
                        "-fx-padding: 8; -fx-background-color: transparent; -fx-background-radius: 10; -fx-border-radius: 10; -fx-border-color: #4caf50; -fx-border-width: 2;");
            } else {
                this.setStyle(
                        "-fx-padding: 8; -fx-background-color: transparent; -fx-background-radius: 10; -fx-border-radius: 10;");
            }
